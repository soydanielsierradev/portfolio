...
/**
 * InfluxDB mark.
 * Path from thesvg.org (slug: influxdb), CC0-1.0.
 * Brand colour (thesvg default variant). Measured contrast is 6.80:1 on the dark
 * theme and 2.51:1 on the light theme. The lower figure sits under the WCAG 3:1
 ...
 */
const InfluxDB = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
