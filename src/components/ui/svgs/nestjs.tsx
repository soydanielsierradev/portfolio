...
/**
 * NestJS mark.
 * Path from thesvg.org (slug: nestjs), CC0-1.0.
 * Brand colour (thesvg default variant). Measured contrast is 3.67:1 on the dark
 * theme and 4.65:1 on the light theme.
 */
