...
/**
 * Zigbee mark.
 * Path from thesvg.org (slug: zigbee), CC0-1.0.
 * Brand colour clears 3:1 against both themes (3.76:1 dark, 4.53:1 light),
 * so it follows the brand-colour convention used by the other skill icons.
 */
const Zigbee = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
