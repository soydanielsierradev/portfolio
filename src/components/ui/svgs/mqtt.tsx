...
/**
 * MQTT mark.
 * Path from thesvg.org (slug: mqtt), CC0-1.0.
 * Brand colour (thesvg default variant). Measured contrast is 1.43:1 on the dark
 * theme and 11.95:1 on the light theme; the lower figure sits under the WCAG 3:1
