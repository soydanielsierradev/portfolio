...
/**
 * SQLite mark.
 * Path from thesvg.org (slug: sqlite), CC0-1.0.
 * Brand colour (thesvg default variant). Measured contrast is 1.43:1 on the dark
 * theme and 11.91:1 on the light theme. The lower figure sits under the WCAG 3:1
...
const SQLite = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
        <linearGradient x1="57.7%" y1="2%" x2="57.7%" y2="94.4%" id="sqlite-a">
      ...
      <path d="M152.8 15H17C10.5 15 5 20.4 5 27V171c30.7-11.8 76.8-22 108.7-21.5a989.7 989.7 0 0 1 39-134.5Z" fill="url(#sqlite-a)"/>
